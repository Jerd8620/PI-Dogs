...
export default function Creator() {
  ...
  function handleSelect(e) {
    ...
    setInput((prevState) => ({
      ...
      temperaments: Array.isArray(prevState.temperaments)
        ? [...prevState.temperaments, selectedTemperament]
        : [selectedTemperament],
    }));
  ...
  function handleSubmit(e) {
    ...
    if (Object.keys(errors).length === 0) {
      ...
      if (errors.name) alert(`You are missing: ${errors.name}`);
      else if (errors.height) alert(`You are missing: ${errors.height}`);
      else if (errors.weight) alert(`You are missing: ${errors.weight}`);
      else if (errors.age) alert(`You are missing: ${errors.age}`);
      else if (errors.image) alert(`You are missing: ${errors.image}`);
